...
# As a result, the main program is much more readable. 
...
# However, the code uses Global statements
# Functions should never modify global variables 
# A function should only use data that is passed into it, make calculations based on that data, 
# and potentially return a result or results. 

# See the modifying the value of the global variable accountBalance. 