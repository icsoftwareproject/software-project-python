...
# Even with just two accounts, you can see that this approach gets out of hand quickly. 

# First, we set three global variables for each account. 

# Also, every function now has an if statement to choose which set of global variables to access or change. 
# Any time we want to add another account, we'll need to add another set of global variables and more if statements in every function. 

# We need a different way to handle an arbitrary number of accounts 