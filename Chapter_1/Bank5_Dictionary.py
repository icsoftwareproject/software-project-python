...
# With this approach, all the data associated with one account can be found in a single dictionary. 

# This cleans things up quite a bit, making the organization of the data more logical.  
...
#  But each of the functions in the program must still have access to the global list of accounts. 

# As we'll see in the next section, granting functions access to all account data raise potential security risks. 
