...
# def someMethod(self, <any other arguments>)
# oSomeObject. someMethod(<any other arguments>)
# self.<instanceVariableName>

# This essentially says to use the object referred to by self 
# and access the instance variable specified by <instanceVariableName>.

# Since every method uses self as the first parameter, every method in 
# a class uses this same approach. 
